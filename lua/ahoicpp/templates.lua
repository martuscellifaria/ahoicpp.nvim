...
def main():
    ...
    cmake_config.write_text(f"""# Automagically generated by botan_fetcher.py
set(BOTAN_INCLUDE_DIR "{botan_output / "include" / "botan-3"}")
...
""")
    ...
    project_cmake = root / "CMakeLists.txt"
    global_block = f"""# Automagically added by botan_fetcher.py
include_directories(${{BOTAN_INCLUDE_DIR}})
link_directories(${{BOTAN_LIB_DIR}})
link_libraries(${{BOTAN_LIBRARY}})
"""
...
def main():
    ...
    cmake_config.write_text(f"""# Automagically generated by eigen_fetcher.py
set(Eigen3_DIR "{eigen_output / "share" / "eigen3" / "cmake"}")
...
""")
    ...
    project_cmake = root / "CMakeLists.txt"
    global_block = """# Automagically added by eigen_fetcher.py
...
def main():
    ...
    cmake_config.write_text(f"""# Automagically generated by grpc_fetcher.py
set(absl_DIR "{grpc_output / "lib" / "cmake" / "absl"}")
...
""")
    ...
    project_cmake = root / "CMakeLists.txt"
    global_block = """# Automagically added by grpc_fetcher.py
...
def main():
    ...
    cmake_config.write_text(f"""# Automagically generated by protobuf_fetcher.py
set(Protobuf_DIR "{protobuf_output / "lib" / "cmake" / "protobuf"}")
find_package(Protobuf REQUIRED PATHS "${{Protobuf_DIR}}" NO_DEFAULT_PATH)
...
""")
    ...
    project_cmake = root / "CMakeLists.txt"
    global_block = """# Automagically added by protobuf_fetcher.py
include_directories(${Protobuf_INCLUDE_DIRS})
...
def main():
    ...
    cmake_config.write_text(f"""# Automagically generated by spdlog_fetcher.py
set(spdlog_DIR "{spdlog_output / "lib" / "cmake" / "spdlog"}")
...
""")
    ...
    project_cmake = root / "CMakeLists.txt"
    global_block = """# Automagically added by spdlog_fetcher.py
link_libraries(spdlog::spdlog)
"""
    target_block = """target_include_directories(ahoicpp_externals INTERFACE ${spdlog_INCLUDE_DIR})
"""
...
def main():
    ...
    cmake_config.write_text(f"""# Automagically generated by open62541_fetcher.py
set(open62541_DIR "{open62541_output / "lib" / "cmake" / "open62541"}")
...
""")
    ...
    project_cmake = root / "CMakeLists.txt"
    global_block = """# Automagically added by open62541_fetcher.py
include_directories(${open62541_INCLUDE_DIRS})
link_libraries(open62541::open62541)
"""
